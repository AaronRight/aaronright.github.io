...
module.exports = __webpack_require__(/*! C:\Users\Victor\Documents\white-noise\src\main.ts */"zUnb");
...
class Noise {
    ...
    static stopNoise(track) {
        if (track.audioSource) {
            clearTimeout(Noise.fadeOutTimer);
            track.audioSource.stop();
        }
    }
    static fadeNoise(track) {
        if (track.fadeOut) {
