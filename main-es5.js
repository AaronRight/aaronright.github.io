(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/
    function GPs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "Angle", function () {
        return Angle;
      });
        ...
        _createClass(Noise, [{
          ...
          value: function unlock(element) {
            ...
            */
            ...
            source.start();
            var silenceDataURL = "data:audio/mp3;base64,//MkxAAHiAICWABElBeKPL/RANb2w+yiT1g/gTok//lP/W/l3h8QO/OCdCqCW2Cw//MkxAQHkAIWUAhEmAQXWUO" + "FW2dxPu//9mr60ElY5sseQ+xxesmHKtZr7bsqqX2L//MkxAgFwAYiQAhEAC2hq22d3///9FTV6tA36JdgBJoOGgc+7qvqej5Zu7/7uI9l//MkxBQHAAYi8AhEAO193vt9K" + "GOq+6qcT7hhfN5FTInmwk8RkqKImTM55pRQHQSq//MkxBsGkgoIAABHhTACIJLf99nVI///yuW1uBqWfEu7CgNPWGpUadBmZ////4sL//MkxCMHMAH9iABEmAsKioqKigs" + "LCwtVTEFNRTMuOTkuNVVVVVVVVVVVVVVVVVVV//MkxCkECAUYCAAAAFVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV";
            element.loop = false;
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./angle */
      "8GPs");
      /* harmony import */


      var _noise__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./noise */
      "NIcn");
      ...
      */
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent() {
          ...
          this.square = "M 410.03327687898815,834.2973455909166  165.70263319587986,589.9667019078083" + " C 115.86107328202843,540.1251419939568  115.86108035309621,459.87485093497526  165.7026331958799,410.03329809219156 " + " L 410.03329809219167,165.70263319587986 " + " C 459.87485093497537,115.86108035309621  540.125141993957,115.86107328202843  589.9667019078083,165.70263319587986 " + " L 834.2973455909166,410.0332768789882 " + " C 884.1388984337004,459.8748297217719  884.1389196469038,540.1251490650247  834.2973668041202,589.9667019078083 " + " L 589.9667019078083,834.2973668041201 " + " C 540.1251490650246,884.1389196469038  459.8748297217719,884.1388984337004  410.03327687898815,834.2973455909166 Z";
          this.triangle = "M 268.6119206416787,784.3000029821019  268.5786371254883,589.9667019078083 " + " C 268.5665738838012,519.4800917859759  268.5665668127334,480.5199011429562  268.5786371254882,410.03329809219167 " + " L 268.61194185488216,215.70000408896578 " + " C 268.62402630977266,145.21340103820125  398.70378575664745,115.86107328202843  448.5453456704989,165.70263319587986 " + " L 692.8759893536072,410.0332768789882 " + " C 742.7175421963909,459.8748297217719  742.7175634095943,540.1251490650247  692.8760105668107,589.9667019078083 " + " L 448.5453456704988,834.2973668041202 " + " C 398.7037928277151,884.1389196469038  268.62398388336567,854.7865989617987  268.6119206416787,784.3000029821019 Z";
        ...
        _createClass(AppComponent, [{
          ...
          key: "rotate",
          value: function rotate(angle_radians, x, y, x_pivot, y_pivot) {
            var s = Math.sin(angle_radians * Math.PI / 180);
            var c = Math.cos(angle_radians * Math.PI / 180);
            x -= x_pivot;
            y -= y_pivot;
            var x_new = x * c - y * s;
            var y_new = x * s + y * c;
          ...
          key: "calculateSvg",
          value: function calculateSvg() {
            var template1 = this.triangle.split(/[\s,]+/);
            var template2 = this.square.split(/[\s,]+/);
            var n = 135;
            var diff = new Array(template1.length + 1);
            var result = new Array(n + 1);

            for (var j = 0; j < template1.length; j++) {
            ...
            for (var i = 0; i < result.length; i++) {
              ...
              for (var _j = 0; _j < diff.length; _j++) {
                result[i][_j] = diff[_j] ? Number(template1[_j]) + diff[_j] * i : template1[_j];
              }
            }
          ...
          value: function perform() {
            ...
            if (!this.doubleClick) {
              ...
              setTimeout(function () {
                _this2.play = !_this2.play;
                _this2.doubleClick = false;
              }, 400);
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 4,
        vars: 0,
        consts: [["width", "1000", "height", "1000", 3, "click"], ["canvas", ""], ["audio", ""]],
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "canvas", 0, 1);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_canvas_click_0_listener() {
              return ctx.perform();
            });
