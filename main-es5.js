(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\Victor\Documents\white-noise\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var Noise = /*#__PURE__*/function () {
        ...
        _createClass(Noise, null, [{
          ...
          value: function createNoise(track) {
            var bufferSize = 2 * Noise.audioContext.sampleRate;
            var noiseBuffer = Noise.audioContext.createBuffer(1, bufferSize, Noise.audioContext.sampleRate);
          ...
          value: function fadeNoise(track) {
            ...
            if (track.canFade) {
              ...
              track.canFade = false;
              Noise.fadeOutTimer = setTimeout(function () {
      ...
      Noise.audioContext = new window.AudioContext();
      var noise = {
        volume: 0.05,
        fadeIn: 2.5,
        fadeOut: 1.3
